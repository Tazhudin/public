...
class MayBeInterested implements ISelectionProductsProvider
{
    /**
     * @behavior get products by sort 'sort' => 'desc'
    ...
    public function getProducts(array $arParams)
    {
        ...
        $dbItems = CIBlockElement::GetList(['SORT' => 'DESC'], $arFilter, false, ['nTopCount' => $arParams['SELECT_ITEMS_COUNT']], $arSelect);
