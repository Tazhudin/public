...
class Bestsellers implements ISelectionProductsProvider
{
    /**
     * @behavior get products by sort 'sort' => 'asc' (в поле сортировки устанавливается значение зависящее от кол-ва продаж !)
    ...
    public function getProducts(array $arParams)
    {
        ...
        $dbItems = CIBlockElement::GetList(['SORT' => 'ASC'], $arFilter, false, ['nTopCount' => $arParams['SELECT_ITEMS_COUNT']], $arSelect);
