...
class Evaluation_05 extends CModule
{
    public $MODULE_ID = 'evaluation.05';

    function __construct()
    {
        $this->MODULE_NAME = 'Оценки заказов';
        $this->MODULE_DESCRIPTION = 'Модуль для работы с оценками заказов';
