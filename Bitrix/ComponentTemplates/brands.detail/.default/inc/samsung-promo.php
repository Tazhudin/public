<div class="brand-promo-wrapper">
      ...
      <div class="brand-promo-section__slider">
        <div class="brand-promo-slider">
          <div class="brand-promo-slider__slides">
            <?php for ($i = 0; $i <= count($arResult['PROMO']['BANNERS']['LINK']) - 1; $i++) : ?>
              <div class="brand-promo-slider__slide-wrapper">
                <a href="<?= $arResult['PROMO']['BANNERS']['LINK']["$i"] ?>" class="brand-promo-slider__slide">
                  <img srcset="<?= $arResult['PROMO']['BANNERS']['PICTURE'][$i] ?>,
                                <?= $arResult['RESIZER']->resize($arResult['PROMO']['BANNERS']['PICTURE'][$i], 400, 400); ?>" src=" <?= $arResult['PROMO']['BANNERS']['PICTURE'][$i] ?>" alt="" class="brand-promo-slider__img">
                </a>
              </div>
            <?php endfor; ?>
          </div>
  ...
  <?php foreach (array_reverse($arResult['PROMO']['GRID']['CHILD']) as $section) : ?>
    <section class="brand-promo-section">
      <div class="brand-promo-section__container">
        ...
        <div class="brand-promo-grid brand-promo-grid_hidden">
          <?php for ($i = 0; $i <= count($section['PICTURE']) - 1; $i++) : ?>
            <a href="<?= $section['PICTURE']["$i"] ?>" class="brand-promo-grid__item">
              <div class="brand-promo-grid__wrap-img">
                <img srcset="<?= $section['PICTURE'][$i] ?>,
                             <?= $section['PICTURE'][$i] ?>" src="<?= $section['PICTURE'][$i] ?>" alt="" class="brand-promo-grid__img">
              </div>
