...
<div class="changelog-page universal-page-mixin">
    ...
    <div class="changelog-page__nav">
        <div class="bem-page-nav bem-page-nav_h50 desktop-only">
            <?php
            $GLOBALS['APPLICATION']->IncludeComponent('bitrix:system.pagenavigation', 'products_list', ['NAV_RESULT' => $cdbResult]);
            ?>
        </div>
    </div>
