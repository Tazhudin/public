...
class CategoryDuplicateListLayout extends Table
{
    // phpcs:disable SlevomatCodingStandard.TypeHints.PropertyTypeHint
    protected $target = 'duplicates';

    protected $title = 'Дублирующие категории';
            ...
            TD::make('Действия')
                ...
                ->render(fn($model) => DropDown::make()
                    ...
                    ->list([
                        ...
                        Button::make('Удалить')
                            ->icon('bs.trash')
                            ->confirm('Действительно хотите удалить связь?')
